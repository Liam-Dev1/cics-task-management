...
export function Sidebar({ onMinimize }: SidebarProps) {
  ...
  if (!mounted) {
    return (
      <div className="w-64 bg-zinc-800 text-white fixed top-0 left-0 h-screen">
  ...
  return (
    <div
      className={cn(
        "bg-zinc-800 text-white fixed top-0 left-0 h-screen z-40 transition-all duration-300",
    ...
    >
      <div className="flex flex-col h-full">
        ...
        {/* Fixed logout button that stays at the bottom */}
